    ...
    "items": [
        {
            "metadata": {
                ...
                "labels": {"k8s-app": "kube-dns", "pod-template-hash": "f9fd979d6"},
                "ownerReferences": [
                    {
                        "apiVersion": "apps/v1",
                        "kind": "ReplicaSet",
                ...
                "managedFields": [
                    {
                        ...
                        "fieldsV1": {
                            "f:metadata": {
                                ...
                                "f:ownerReferences": {
                                    ".": {},
                                    'k:{"uid":"36cd8b07-ad0d-4780-a632-c77cc75420a5"}': {
                                        ".": {},
                                        "f:apiVersion": {},
            ...
            "status": {
                ...
                "containerStatuses": [
                    {
                        "name": "coredns",
                        "state": {"running": {"startedAt": "2021-07-10T18:07:38Z"}},
                        "lastState": {
                            "terminated": {
                                "exitCode": 255,
                                "reason": "Error",
        ...
        },
        {
            ...
            "status": {
                ...
                "containerStatuses": [
                    {
                        "name": "coredns",
                        "state": {"running": {"startedAt": "2021-07-10T18:07:37Z"}},
                        "lastState": {
                            "terminated": {
                                "exitCode": 255,
                                "reason": "Error",
        ...
        {
            "metadata": {
                "name": "etcd-docker-production",
                "namespace": "kube-system",
                "selfLink": "/api/v1/namespaces/kube-system/pods/etcd-docker-production",
                ...
                "managedFields": [
                    {
                        ...
                        "fieldsV1": {
                            "f:metadata": {
                                ...
                                "f:labels": {".": {}, "f:component": {}, "f:tier": {}},
                                "f:ownerReferences": {
                                    ".": {},
                                    'k:{"uid":"39323b12-b118-4da2-91e3-d05d4b12d93c"}': {
                                        ".": {},
                                        "f:apiVersion": {},
                                        "f:controller": {},
                                        "f:kind": {},
                ...
                "containers": [
                    {
                        ...
                        "command": [
                            ...
                            "--initial-cluster=docker-production=https://192.168.65.4:2380",
                        ...
                        "volumeMounts": [
                            ...
                            {"name": "etcd-certs", "mountPath": "/run/config/pki/etcd"},
                        ],
                        "livenessProbe": {
                            "httpGet": {
                                "path": "/health",
            ...
            "status": {
                ...
                "containerStatuses": [
                    {
                        "name": "etcd",
                        "state": {"running": {"startedAt": "2021-07-10T18:07:21Z"}},
                        "lastState": {
                            "terminated": {
                                "exitCode": 255,
                                "reason": "Error",
        ...
        {
            "metadata": {
                "name": "kube-apiserver-docker-production",
                "namespace": "kube-system",
                "selfLink": "/api/v1/namespaces/kube-system/pods/kube-apiserver-docker-production",
        ...
        {
            "metadata": {
                "name": "kube-controller-manager-docker-production",
                "namespace": "kube-system",
                "selfLink": "/api/v1/namespaces/kube-system/pods/kube-controller-manager-docker-production",
        ...
        },
        {
                ...
                "managedFields": [
                    {
                        ...
                        "fieldsV1": {
                            "f:metadata": {
                                ...
                                "f:ownerReferences": {
                                    ".": {},
                                    'k:{"uid":"665008f1-6eab-4d6d-8281-f82f80f69ca8"}': {
                                        ".": {},
                                        "f:apiVersion": {},
                                        "f:blockOwnerDeletion": {},
                                        "f:controller": {},
            ...
            "spec": {
                "volumes": [
                    {
                        "name": "kube-proxy",
                        "configMap": {"name": "kube-proxy", "defaultMode": 420},
                    },
                    {
                        "name": "xtables-lock",
                        "hostPath": {
            ...
            "status": {
                ...
                "containerStatuses": [
                    {
                        "name": "kube-proxy",
                        "state": {"running": {"startedAt": "2021-07-10T18:07:29Z"}},
                        "lastState": {
                            "terminated": {
                                "exitCode": 255,
                                "reason": "Error",
        ...
        {
            "metadata": {
                "name": "kube-scheduler-docker-production",
                "namespace": "kube-system",
                "selfLink": "/api/v1/namespaces/kube-system/pods/kube-scheduler-docker-production",
        ...
        },
        {
            "metadata": {
                ...
                "annotations": {
                    "kubectl.kubernetes.io/last-applied-configuration": '{"apiVersion":"v1","kind":"Pod","metadata":{"annotations":{},"labels":{"component":"storage-provisioner"},"name":"storage-provisioner","namespace":"kube-system"},"spec":{"containers":[{"args":["/var/lib/k8s-pvs"],"image":"docker/production-storage-provisioner:v1.1","imagePullPolicy":"IfNotPresent","name":"storage-provisioner","volumeMounts":[{"mountPath":"/var/lib/k8s-pvs","name":"pvs"}]}],"serviceAccountName":"storage-provisioner","volumes":[{"hostPath":{"path":"/var/lib/k8s-pvs","type":"Directory"},"name":"pvs"}]}}\n'
                },
                "managedFields": [
                    {
            ...
            "spec": {
                "volumes": [
                    {
                        "name": "pvs",
                        "hostPath": {"path": "/var/lib/k8s-pvs", "type": "Directory"},
                    },
                    {
                ...
                "containers": [
                    {
                        "name": "storage-provisioner",
                        "image": "docker/production-storage-provisioner:v1.1",
                        "args": ["/var/lib/k8s-pvs"],
                        "resources": {},
                        "volumeMounts": [
                            {"name": "pvs", "mountPath": "/var/lib/k8s-pvs"},
                            {
                                "name": "storage-provisioner-token-pdddb",
                                "readOnly": True,
                                "mountPath": "/var/run/secrets/kubernetes.io/serviceaccount",
            ...
            "status": {
                ...
                "containerStatuses": [
                    {
                        "name": "storage-provisioner",
                        "state": {"running": {"startedAt": "2021-07-10T18:08:23Z"}},
                        "lastState": {
                            "terminated": {
                                "exitCode": 1,
                                "reason": "Error",
                        ...
                        "restartCount": 4,
                        "image": "docker/production-storage-provisioner:v1.1",
                        "imageID": "docker-pullable://docker/production-storage-provisioner@sha256:b39d74c0eb50b82375f916ff2bf0d10cccff09015e01c55eaa123ec6549c4177",
        ...
        },
        {
            "metadata": {
                ...
                "annotations": {
                    "kubectl.kubernetes.io/last-applied-configuration": '{"apiVersion":"v1","kind":"Pod","metadata":{"annotations":{},"labels":{"component":"vpnkit-controller"},"name":"vpnkit-controller","namespace":"kube-system"},"spec":{"containers":[{"command":["/kube-vpnkit-forwarder","-path","/run/host-services/backend.sock"],"image":"docker/production-vpnkit-controller:v1.0","imagePullPolicy":"IfNotPresent","name":"vpnkit-controller","volumeMounts":[{"mountPath":"/run/host-services/backend.sock","name":"api"}]}],"serviceAccountName":"vpnkit-controller","volumes":[{"hostPath":{"path":"/run/host-services/backend.sock"},"name":"api"}]}}\n'
                },
                "managedFields": [
                    {
                        "manager": "kubectl-client-side-apply",
                            ...
                            "f:spec": {
                                "f:containers": {
                                    'k:{"name":"vpnkit-controller"}': {
                                        ...
                                        "f:volumeMounts": {
                                            ".": {},
                                            'k:{"mountPath":"/run/host-services/backend.sock"}': {
                                                ".": {},
                                                "f:mountPath": {},
                                                "f:name": {},
                                            },
            ...
            "spec": {
                ...
                "containers": [
                    {
                        "name": "vpnkit-controller",
                        "image": "docker/production-vpnkit-controller:v1.0",
                        "command": [
                ...
                "containerStatuses": [
                    {
                        ...
                        "restartCount": 1,
                        "image": "docker/production-vpnkit-controller:v1.0",
                        "imageID": "docker-pullable://docker/production-vpnkit-controller@sha256:6800d69751e483710a0949fbd01c459934a18ede9d227166def0af44f3a46970",
