...
func generateConfig(cfg *config.Config, namespace string, podNames []string, resourceVersion string) map[string]interface{} {
...
func GenerateKubeSystemConfig(cfg *config.Config, namespace string) map[string]interface{} {
	podNames := []string{
	...
	return generateConfig(cfg, namespace, podNames, "1110")
}


func GenerateDefaultNamespaceConfig(cfg *config.Config, namespace string) map[string]interface{} {
	podNames := []string{
	...
	return generateConfig(cfg, namespace, podNames, "3572")
}
